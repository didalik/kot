...
function dopad (makeIds, log) { // {{{1
  ...
  post_jcl(null, null, null, // node, run, cmd,
    //0 1     2                                                           3        4      5                          6        7
    pk, 'hx', 'GD5J36GTTAOV3ZD3KLLEEY5WES5VHRWMUTHN3YYTOLA2YR3P3KPGXGAQ', 'dopad', 'put', 'hx_Agent_make2map_txids', makeIds, sk,
    { hx_Agent_make2map_txids: makeIds } // 8
  ).then(r => resolve(r))
  return promise;
}
...
export { // {{{1
  dopad, hx_use_tm, setup_selftest,
}
